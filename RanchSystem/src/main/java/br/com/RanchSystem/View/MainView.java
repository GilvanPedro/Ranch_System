...
public class MainView extends JFrame {
    ...
    private JPanel createGadoPanel() {
        ...
        modelGado = new DefaultTableModel(new String[]{"Nome", "Série", "RGN", "Raça", "Sexo", "Proprietário"}, 0);
        ...
        btnExcluir.addActionListener(e -> {
            ...
            if (row != -1 && JOptionPane.showConfirmDialog(this, "Excluir?") == 0) {
                gadoController.removerGado((long) modelGado.getValueAt(row, 2));
    ...
    private void refreshGadoTable() {
        ...
        for (Gado g : gadoController.getGadosLista()) modelGado.addRow(new Object[]{g.getNome(), g.getSerie(), g.getRgn(), g.getRaca(), g.isSexo() ? "Fêmea" : "Macho", g.getProprietario()});
    }
