...
public class GadoController {
    ...
    // ADICIONAR GADO
    public String adicionarGado(String nome, String nascimento, String raca, String proprietario, String serie, long rgn, String categoria, byte totalFilhos, boolean sexo) {
